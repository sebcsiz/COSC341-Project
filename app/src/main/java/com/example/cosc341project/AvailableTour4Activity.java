    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        homeButton.setOnClickListener(new View.OnClickListener(){
            ...
            public void onClick(View view) {
                ...
                Intent homeIntent = new Intent(AvailableTour4Activity.this, SearchActivity.class); //import Intent class (swap SearchActivity.class with ????Activity)
        ...
        myToursButton.setOnClickListener(new View.OnClickListener(){
            ...
            public void onClick(View view) {
                // Create Intent to start ????Activity
                Intent myToursIntent = new Intent(AvailableTour4Activity.this, SearchActivity.class); //import Intent class (swap SearchActivity.class with ????Activity)
        ...
        profileButton.setOnClickListener(new View.OnClickListener(){
            ...
            public void onClick(View view) {
                ...
                Intent profileIntent = new Intent(AvailableTour4Activity.this, ProfileActivity.class); //import Intent class
        ...
        bookButton.setOnClickListener(new View.OnClickListener(){
            ...
            public void onClick(View view) {
                // Create Intent to start ????Activity
                Intent bookIntent = new Intent(AvailableTour4Activity.this, SearchActivity.class); //import Intent class (swap SearchActivity.class with ????Activity)
