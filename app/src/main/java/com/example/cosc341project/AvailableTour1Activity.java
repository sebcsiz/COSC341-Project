    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        homeButton.setOnClickListener(new View.OnClickListener(){
            ...
            public void onClick(View view) {
                ...
                Intent homeIntent = new Intent(AvailableTour1Activity.this, SearchActivity.class); //import Intent class
        ...
        myToursButton.setOnClickListener(new View.OnClickListener(){
            ...
            public void onClick(View view) {
                ...
                Intent myToursIntent = new Intent(AvailableTour1Activity.this, SearchActivity.class); //(swap SearchActivity.class with ????Activity.class)
        ...
        profileButton.setOnClickListener(new View.OnClickListener(){
            ...
            public void onClick(View view) {
                ...
                Intent profileIntent = new Intent(AvailableTour1Activity.this, ProfileActivity.class); //check????
        ...
        bookButton.setOnClickListener(new View.OnClickListener(){
            ...
            public void onClick(View view) {
                ...
                Intent bookIntent = new Intent(AvailableTour1Activity.this, BookingActivity.class); //(swap SearchActivity.class with ????Activity.class)
