...
public class AvailableTour2Activity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_available_tour2);
        ...
        homeButton.setOnClickListener(new View.OnClickListener(){
            ...
            public void onClick(View view) {
                ...
                Intent homeIntent = new Intent(AvailableTour2Activity.this, SearchActivity.class); //import Intent class (swap SearchActivity.class with ????Activity)
        ...
        myToursButton.setOnClickListener(new View.OnClickListener(){
            ...
            public void onClick(View view) {
                // Create Intent to start ????Activity
                Intent myToursIntent = new Intent(AvailableTour2Activity.this, SearchActivity.class); //import Intent class (swap SearchActivity.class with ????Activity)
        ...
        profileButton.setOnClickListener(new View.OnClickListener(){
            ...
            public void onClick(View view) {
                ...
                Intent profileIntent = new Intent(AvailableTour2Activity.this, ProfileActivity.class); //import Intent class
        ...
        toWineryInfoButton.setOnClickListener(new View.OnClickListener(){
            ...
            public void onClick(View view) {
                ...
                Intent toWineryInfoIntent = new Intent(AvailableTour2Activity.this, WineryInfoActivity.class);
        ...
        bookButton.setOnClickListener(new View.OnClickListener(){
            ...
            public void onClick(View view) {
                // Create Intent to start ????Activity
                Intent bookIntent = new Intent(AvailableTour2Activity.this, SearchActivity.class); //import Intent class (swap SearchActivity.class with ????Activity)
